...
// Code styling
gulp.task('style', ['scripts', 'css', 'lint'], function() {
  return gulp
    .src(customJsFiles)
    .pipe(jscs())
    .pipe(jscs.reporter());
...
gulp.task('watch', function() {
  ...
  gulp.watch('./src/client/app/**/*.tpl.html', ['lint', 'style', 'scripts']);
...
gulp.task('default', [
   'scripts', 'css', 'lint', 'style', 'html', 'watch'
]);
